...
class Main(object):
    ...
    def apt_error(self, **kwargs):
        ...
        if 'Unable to connect to' in kwargs.get('exception', ''):
            ...
            _ = DIALOG.ok(lang(32087), '[CR]'.join([lang(32131), lang(32132)]))
    ...
    def apt_action_list_error(self, **kwargs):
        ...
        # notify the user that an error has occured with an update
        _ = DIALOG.ok(lang(32087), '[CR]'.join([lang(32112), '', lang(32113)]))
    ...
    def action_list(self, action):
        ...
        if root_space:
            ...
            _ = DIALOG.ok(lang(32077), '[CR]'.join([lang(32129), lang(32130)]))
    ...
    def action_list_complete(self):
        ...
        if any([os.path.isfile('/tmp/reboot-needed'), os.path.isfile('fname/var/run/reboot-required')]):
            reboot = DIALOG.yesno(lang(32090), '[CR]'.join([lang(32091), lang(32133)]), yeslabel=lang(32081), nolabel=lang(32082))
    ...
    def apt_commit_complete(self):
        ...
        if self.check_if_reboot_required():
            ...
            reboot = DIALOG.yesno(lang(32077), '[CR]'.join([lang(32079), lang(32080)]), yeslabel=lang(32081), nolabel=lang(32082))
    ...
    def settings_command_action(self):
        ...
        if not check_connection:
            ...
            _ = DIALOG.ok(lang(32136), '[CR]'.join([lang(32137), lang(32138)]))
    ...
    def settings_command_backup(self):
        ...
        try:
            ...
            _ = DIALOG.ok(lang(32096), lang(32097))
    ...
    def settings_command_restore(self):
        ...
        try:
            ...
            if bckp.success != 'Full':
                ...
                _ = DIALOG.ok(lang(32139), '[CR]'.join([lang(32140), lang(32141)]))
            ...
            if restart_required:
                ...
                user_input_restart_now = DIALOG.yesno(lang(32110), '[CR]'.join([lang(32098), lang(32099)]), yeslabel=lang(32100), nolabel=lang(32101))
    ...
    def display_update_warning(self):
        ...
        user_confirm = DIALOG.yesno(lang(32077), '[CR]'.join([lang(32128), lang(32127), lang(32126)]), yeslabel=lang(32125), nolabel=lang(32124))
        ...
        if self.s['on_upd_detected'] == 0 or data == 'manual_update_complete':
            ...
            if self.EXTERNAL_UPDATE_REQUIRED == 1:
                ...
                if install:
                    ...
                    _ = DIALOG.ok(lang(32072), '[CR]'.join([lang(32085), lang(32086)]))
    ...
    def check_for_unsupported_version(self):
        ...
        if process == 0:
            ...
            _ = DIALOG.ok(lang(32102), '[CR]'.join([lang(32103), lang(32104)]))
            ...
            if not freespace:
                ...
                if 'Home.xml' in xbmc.getInfoLabel('Window.Property(xmlfile)'):
                    ...
                    if self.freespace_remedy == 'apt':
                        ...
                        resp = DIALOG.yesno(lang(32136),
                                            '[CR]'.join([lang(32142) % int(value), lang(32143)]))
                        ...
                        _ = DIALOG.ok(lang(32136),
                                      '[CR]'.join([lang(32142) % int(value), lang(32144)]))
