...
class osmc_backup(object):
    ...
    def check_backup_location(self):
        ...
        if not self.location:
            ...
            _ = DIALOG.ok(lang(32147), '[CR]'.join([lang(32148), lang(32149)]))
        ...
        if not self.check_target_location_for_size(self.location):
            ...
            _ = DIALOG.ok(lang(32147), lang(32150))
        ...
        if not self.check_target_writeable(self.location):
            ...
            _ = DIALOG.ok(lang(32147), lang(32151))
    ...
    def create_tarball(self):
        ...
        try:
            ...
            if success:
                ...
                _ = DIALOG.ok(lang(32152), lang(32153))
    ...
    def start_restore(self):
        ...
        while back_to_select:
            ...
            # display the list
            file_selection = DIALOG.select(lang(32154), [x[1] for x in dialog_list])
            ...
            if file_selection == -1:
                ...
                backup_file = DIALOG.browse(1, lang(32155), 'files')
                ...
                if not result:
                    ...
                    _ = DIALOG.ok(lang(32145), lang(32156))
                    back_to_select = False
                    continue
            ...
            try:
                ...
                _ = DIALOG.ok(lang(32145), lang(32146))
            ...
            if members:
                ...
                if len(tar_contents_list) < 2:
                    ...
                    _ = DIALOG.ok(lang(32139), lang(32157))
            ...
            if self.success == 'Full' and not self.restoring_guisettings:
                _ = DIALOG.ok(lang(32110), lang(32158))
