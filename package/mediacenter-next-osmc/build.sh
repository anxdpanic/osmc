...
pull_source "https://github.com/xbmc/xbmc/archive/f95ee8244873509324c85577ec2f3b6e583fb45c.tar.gz" "$(pwd)/src"
API_VERSION="19"
...
then
	...
	ADDONS_GAME="game.libretro game.libretro.2048 game.libretro.beetle-gba game.libretro.fceumm game.libretro.gw game.libretro.beetle-pce-fast game.libretro.bnes game.libretro.nestopia game.libretro.bsnes-mercury-balanced game.libretro.bluemsx game.libretro.vecx game.libretro.gambatte game.libretro.beetle-bsnes game.libretro.meteor game.libretro.mgba game.libretro.vba-next game.libretro.quicknes game.libretro.snes9x game.libretro.stella game.libretro.dosbox game.libretro.vbam game.libretro.genplus"
	if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
	then
