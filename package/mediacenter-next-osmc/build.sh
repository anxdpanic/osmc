...
if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
then
pull_source "https://github.com/popcornmix/xbmc/archive/fffe47f94242382c905dece99aa04579cf1571e6.tar.gz" "$(pwd)/src"
API_VERSION="19"
else
pull_source "https://github.com/xbmc/xbmc/archive/41682a3ff406dd3d27dd9f5e4e477a7418264ef7.tar.gz" "$(pwd)/src"
API_VERSION="19"
