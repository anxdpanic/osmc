...
if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
then
pull_source "https://github.com/popcornmix/xbmc/archive/9208b1a317185b55d067f43914206e88527be229.tar.gz" "$(pwd)/src"
API_VERSION="19"
else
pull_source "https://github.com/xbmc/xbmc/archive/0bb0b9f4e1cce7980760113969ae3d93bebe088f.tar.gz" "$(pwd)/src"
API_VERSION="19"
...
then
	...
	ADDONS_PVR="pvr.hts pvr.waipu pvr.mythtv pvr.pctv pvr.stalker pvr.zattoo pvr.vbox pvr.wmc pvr.nextpvr pvr.njoy pvr.teleboy pvr.vdr.vnsi pvr.dvbviewer pvr.hdhomerun pvr.iptvsimple pvr.demo pvr.mediaportal.tvserver pvr.argustv pvr.dvblink  pvr.vuplus pvr.freebox pvr.octonet" #pvr.sledovanitv.cz
