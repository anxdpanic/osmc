...
pull_source "https://github.com/xbmc/xbmc/archive/e1d4e5ecc5658daebb405377b99fd7ce0579f570.tar.gz" "$(pwd)/src"
API_VERSION="19"
...
then
	...
	ADDONS_PVR="pvr.waipu pvr.sledovanitv.cz pvr.mythtv pvr.pctv pvr.stalker pvr.zattoo pvr.vbox pvr.wmc pvr.nextpvr pvr.njoy pvr.teleboy pvr.vdr.vnsi pvr.dvbviewer pvr.hdhomerun pvr.iptvsimple pvr.demo pvr.mediaportal.tvserver pvr.argustv pvr.dvblink  pvr.hts pvr.octonet" # pvr.vuplus
