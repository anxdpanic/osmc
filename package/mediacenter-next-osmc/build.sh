...
then
	...
	ADDONS_PVR="pvr.waipu pvr.sledovanitv.cz pvr.mythtv pvr.hts pvr.pctv pvr.stalker pvr.octonet pvr.zattoo pvr.vbox pvr.wmc pvr.nextpvr pvr.njoy pvr.teleboy pvr.vdr.vnsi pvr.vuplus pvr.dvbviewer pvr.hdhomerun pvr.iptvsimple pvr.demo pvr.mediaportal.tvserver pvr.dvblink pvr.argustv" #pvr.filmon 
