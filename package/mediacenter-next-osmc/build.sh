...
if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
then
pull_source "https://github.com/popcornmix/xbmc/archive/1e67239bd67e0636e530dceceb01a4cb8ea07dd4.tar.gz" "$(pwd)/src"
API_VERSION="19"
else
pull_source "https://github.com/xbmc/xbmc/archive/738e205e1ac73431dd528f7aea60b4efc6c97223.tar.gz" "$(pwd)/src"
API_VERSION="19"
...
then
	...
	ADDONS_GAME="game.libretro.mame2000 game.libretro.mame2003 game.libretro.scummvm game.libretro.yabause game.libretro game.libretro.2048 game.libretro.beetle-gba game.libretro.fceumm game.libretro.gw game.libretro.beetle-pce-fast game.libretro.bnes game.libretro.nestopia game.libretro.bsnes-mercury-balanced game.libretro.bluemsx game.libretro.vecx game.libretro.gambatte game.libretro.beetle-bsnes game.libretro.meteor game.libretro.mgba game.libretro.vba-next game.libretro.quicknes game.libretro.snes9x game.libretro.stella game.libretro.dosbox game.libretro.vbam game.libretro.genplus"
	if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
	then
