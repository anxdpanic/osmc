...
pull_source "https://github.com/xbmc/xbmc/archive/944a94a482a064ae53743eb891cf6f01fb22b19e.tar.gz" "$(pwd)/src"
API_VERSION="19"
...
then
	...
	ADDONS_IMAGE_DECODERS="imagedecoder.heif imagedecoder.raw imagedecoder.mpo"
	if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
	then
