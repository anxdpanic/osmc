...
if [ "$1" == "rbp1" ] || [ "$1" == "rbp2" ]
then
pull_source "https://github.com/popcornmix/xbmc/archive/d632c454e73f49c81a0d4a8de74b082a78e9f2d4.tar.gz" "$(pwd)/src"
API_VERSION="19"
else
pull_source "https://github.com/xbmc/xbmc/archive/846673ef7dd5d32656d720acaab25d12f834523a.tar.gz" "$(pwd)/src"
API_VERSION="19"
...
then
	...
	ADDONS_PVR="pvr.hts pvr.waipu pvr.sledovanitv.cz pvr.mythtv pvr.pctv pvr.stalker pvr.zattoo pvr.vbox pvr.wmc pvr.nextpvr pvr.njoy pvr.teleboy pvr.vdr.vnsi pvr.dvbviewer pvr.hdhomerun pvr.iptvsimple pvr.demo pvr.mediaportal.tvserver pvr.argustv pvr.dvblink  pvr.octonet pvr.vuplus pvr.freebox"
